...
public class User {
	...
	//@DynamoDBAutoGeneratedKey//TODO check if this key should be autogenerated? 
	...
	private HashMap<String, String> socialMedia;//TODO check if this should be Set<String>?

	@DynamoDBAttribute(attributeName = "privacy")
	private HashMap<String, Boolean> privacy;//TODO check if this field is used?
